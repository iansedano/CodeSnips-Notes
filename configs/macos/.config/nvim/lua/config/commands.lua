...
create_basic_command("DiagnosticOpenFloat", vim.diagnostic.open_float)
create_basic_command("DiagnosticGoToNext", vim.diagnostic.goto_next)
create_basic_command("DiagnosticGoToPrev", vim.diagnostic.goto_prev)
